                ...
                <tbody>
                    @foreach ($books as $book)
                        <tr>
                            ...
                            <td>
                                <a href=" {{ route('books.edit', ['id' => $book->id]) }} " class="btn btn-primary btn-sm">
                                    Edit
                                </a>

                                <form action=" {{ route('books.destroy', ['id' => $book->id]) }} " class="d-inline" onsubmit="return confirm('Move book to trash?')" method="POST">
                                    @csrf
                                    @method('DELETE')
