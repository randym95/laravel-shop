                ...
                <tbody>
                    @foreach ($books as $book)
                        <tr>
                            ...
                            <td>
                                <form action=" {{ route('books.restore', ['id' => $book->id]) }} " method="POST" class="d-inline">
                                    @csrf
                                    <input type="submit" value="Restore" class="btn btn-success btn-sm">
                                </form>

                                <form action=" {{ route('books.delete-permanent', ['id' => $book->id]) }} " class="d-inline" method="POST" onsubmit="return confirm('Delete this book permanently?')">
                                    @csrf
                                    @method('DELETE')
